...
abstract class Shape2 implements Serializable {
    ...
    public static Shape2 randomFactory() {
        ...
        switch (counter++ % 3) {
            default:
            case 0:
                return new Circle2(xVal, yVal, dim);
            case 1:
                return new Square2(xVal, yVal, dim);
            case 2:
                return new Line2(xVal, yVal, dim);
        }
    }
}
...
// Save the state vector:
        ObjectOutputStream out = new ObjectOutputStream(
                new FileOutputStream("src/io/StoreCADState2.out"));
...
// Now read the file back in:
        ObjectInputStream in = new ObjectInputStream(
                new FileInputStream("src/io/StoreCADState2.out"));
