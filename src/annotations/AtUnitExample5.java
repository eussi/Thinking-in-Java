...
public class AtUnitExample5 {
  ...
  @TestObjectCreate static AtUnitExample5 create() {
    ...
    try {
      output = new PrintWriter("src/annotations/AtUnitExample5" + id + ".txt");
    } catch(IOException e) {
  ...
  public static void main(String[] args) throws Exception {
    OSExecute.command(
      "java -cp out/production/Thinking-in-Java net.mindview.atunit.AtUnit out/production/Thinking-in-Java/annotations/AtUnitExample5");
  }
} /* Output:
